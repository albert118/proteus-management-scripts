...
def analyze_video_similarity(original, reencoded, ffmpeg_path, output_log, thread_limit):
    ...
    Uses C-level native pipe wrappers to eliminate Python interpreter loops.
    """
    ...
    server_socket.bind(('127.0.0.1', 0)) # 0 automatically picks any free open port
    ...
    print(f"Ephemeral TCP socket instantiated to resolve progress. Listening at 127.0.0.1:{port}")
