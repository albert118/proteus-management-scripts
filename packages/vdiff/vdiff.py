...
# TODO: [ ] confirm parallel processing isn't skipping frames (test batch splitting)
# TODO: [ ] cancelling parallel processing leaves hanging ffmpeg processes!!! Need to clean these up correctly
